...
# def _build_timeline_heatmap(raw_timeline: list) -> tuple:
#     '''
#     Recibe rows con {anio, mes, total}.
#     Retorna (timeline_data, heatmap_anios, heatmap_json).
#     '''
#     timeline_data = [
...
#     URL: /dashboard/encuestas/satisfaccion/buscar/<campo>/
...
#     """
#     Endpoint AJAX para los KPIs globales del panel superior.
#     Llamado por JS al cargar la página o al cambiar filtros de KPIs.
#     """
...
#     # ── Filtros de KPIs (solo se guardan para que el JS los use) ──
#     kpi_sucursales   = request.GET.getlist("kpi_sucursal")
#     kpi_fecha_inicio = request.GET.get("kpi_fecha_inicio", "")
#     kpi_fecha_fin    = request.GET.get("kpi_fecha_fin", "")
 
#     # ── Opciones de sucursal para el selector de KPIs ────────────
#     # Solo este select necesita todas las opciones precargadas
#     # (es un multi-select estático, no AJAX) 
#     datos = []
#     opciones_sucursal = []
...
#         timeline_data, heatmap_anios, heatmap_json = _build_timeline_heatmap(raw_timeline)
#     except Exception as e:
#         print(">>> ERROR:", e)
...
#         "table":             table,
#         "filtros":           filtros,
#         # KPIs: los valores se cargan vía AJAX en el template
#         "kpi_sucursales":    kpi_sucursales,
#         "kpi_fecha_inicio":  kpi_fecha_inicio,
#         "kpi_fecha_fin":     kpi_fecha_fin,
#         "opciones_sucursal": opciones_sucursal,  # solo para el selector KPI
...
#         raw_timeline = encuesta_pagina_web.ReporteEncuestaPaginaWeb.obtener_timeline()
#         timeline_data, heatmap_anios, heatmap_json = _build_timeline_heatmap(raw_timeline)
...
#         raw_timeline = encuesta_whatsapp_agente.ReporteEncuestaWhatsappAgente.obtener_timeline()
#         timeline_data, heatmap_anios, heatmap_json = _build_timeline_heatmap(raw_timeline)
...
#         raw_timeline = encuesta_whatsapp.ReporteEncuestaWhatsapp.obtener_timeline()
#         timeline_data, heatmap_anios, heatmap_json = _build_timeline_heatmap(raw_timeline)
...
#     attrs = {
#         "Fecha": dt2.Column(verbose_name="Fecha"),
#     }
#     for pregunta in preguntas_orden:
#         attrs[pregunta] = dt2.Column(
...
#     TableClass = type("EncuestaFeriaSaludDynamicTable", (dt2.Table,), attrs)
...
# #==============================================================#
# #========== MODULO PERFIL AGENTES =============================#
# #==============================================================#

# # ── Configuración por tipo de encuesta ───────────────────────────
# PERFIL_CONFIG = {
#     "sat": {
#         "nombre":       "Satisfacción",
#         "color":        "primary",
...
#     """Retorna el service correcto según el tipo de encuesta."""
...
#     ranking_data = service.obtener_ranking(
#         agente_info.get("Unidad", ""), agente_nombre
#     )
...
#             rank   = service.obtener_ranking(unidad, agente_nombre)
